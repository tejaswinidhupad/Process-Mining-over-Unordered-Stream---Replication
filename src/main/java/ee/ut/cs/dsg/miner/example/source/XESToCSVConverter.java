...
public class XESToCSVConverter {
    ...
    public static  void main(String[] args)
    {
        ...
        preprocessor = new XESPreprocessor("D:\\TUe\\Q2\\Seminar Process Analytics\\Reproduce Experimental Results\\Process-Discovery-over-unordered-streams-master\\data\\DATA2.xml");
        preprocessor.parseToCSV("D:\\TUe\\Q2\\Seminar Process Analytics\\Reproduce Experimental Results\\Process-Discovery-over-unordered-streams-master\\data\\DATA2.csv");
